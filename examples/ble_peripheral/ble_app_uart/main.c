...
//    nrf_gpio_cfg_output(NRF_GPIO_PIN_MAP(0, 24));   
    nrf_gpiote_task_configure(3, NRF_GPIO_PIN_MAP(0, 31), NRF_GPIOTE_POLARITY_TOGGLE, NRF_GPIOTE_INITIAL_VALUE_LOW);
//    nrf_drv_gpiote_out_config_t out_config = GPIOTE_CONFIG_OUT_SIMPLE(false);
//    err_code = nrf_drv_gpiote_out_init(PIN_OUT, &out_config);
//    APP_ERROR_CHECK(err_code);
    nrf_gpiote_task_enable(3);

    nrf_gpiote_task_configure(2, NRF_GPIO_PIN_MAP(0, 17), NRF_GPIOTE_POLARITY_TOGGLE, NRF_GPIOTE_INITIAL_VALUE_HIGH);
    nrf_gpiote_task_enable(2);
    nrf_gpiote_task_configure(1, NRF_GPIO_PIN_MAP(0, 19), NRF_GPIOTE_POLARITY_TOGGLE, NRF_GPIOTE_INITIAL_VALUE_LOW);
...
#warning Debug pin not set
    ...
    nrf_ppi_channel_endpoint_setup(     //associate TIMER3->EVENTS_COMPARE[4] with NRF_GPIOTE->TASKS_OUT[3]
        NRF_PPI_CHANNEL0, 
    ...
    nrf_ppi_channel_endpoint_setup(     //associate TIMER2->EVENTS_COMPARE[2] with NRF_GPIOTE->TASKS_OUT[2]
        NRF_PPI_CHANNEL10, 
        (uint32_t) nrf_timer_event_address_get(NRF_TIMER2, NRF_TIMER_EVENT_COMPARE2),
